  ...
  List<Map<String, String>> messages = [
    {
      "role": "ai",
      "text":
          "I am Mark, your AI Career Guide. System initialization complete. How can I assist your career optimization today?",
    },
  ];
    ...
    try {
      ...
      setState(() {
        messages.add({
          "role": "ai",
          "text":
              "CRITICAL_ERROR: Network connection failed. Check backend status.",
        });
      });
    } finally {
      setState(() {
                          ...
                          child:
                              Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isUser
                                          ? AppTheme.secondaryBlue.withOpacity(
                                              0.05,
                                            )
